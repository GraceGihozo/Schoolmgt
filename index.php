...
<html>
    <head>
        ...
        <title>ALU Automate System</title>
    ...
    <body>
        ...
        <div class="container">
            <h1 class="title">Welcome to the ALU Automate System</h1>
            <h3>Access and manage administrative or academic requests used by the ALU Community</h3>
