...
if(isset($_POST['borrow'])){
  ...
  if(isset($_SESSION['login_user'])){
      ...
      if($result===TRUE)
        {
            echo "<script>alert('Document borrowing request submitted!');
            window.location='faculty.php';
            </script>";
        }      
        else
        {
            echo"Sorry!Document could not be borrowed. Try again later!";
        }
...
<html>
  <head>
    <title> Welcome to the ALU Automate System </title>
...
<ul>
  ...
  <li><a href="#news">My requests</a></li>
            ...
            while($row = mysqli_fetch_array($query)){ ?>
              <tbody class="table-elements">
                ...
                <form method = "POST" action="faculty.php">
                  ...
                  <td>
                    <button name='borrow' type='submit' value='Borrow' class='btn btn-warning'>Request</button>
                  </td>
                </form>
              </tbody>
            <?php
